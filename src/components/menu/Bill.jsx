...
const Bill = () => {
  return (
    <>
        ...
        <div className='flex items-center justify-between px-5 mt-2'>
            <p className='text-xs text-[#ababab] font-medium mt-2'>Tax(6.25%)</p>
            <h1 className='text-[#f5f5f5] text-md font-bold'>₹26</h1>
        </div>
        ...
        <div className='flex items-center gap-3 px-5 mt-4'>
            ...
            <button className='bg-yellow-400 px-4 py-3 w-full rounded-lg text-[#1f1f1f] font-semibold text-lg'>Place Order</button>
        </div>
    </>
  )
}
